...
void tx_wpa_2_of_4 (struct wpa_common_ctx *ctx, struct eapol_key_pkt *eapol_key);
int rx_wpa_3_of_4 (struct wpa_common_ctx *ctx, struct eapol_key_pkt *eapol_key);
void tx_wpa_4_of_4 (struct wpa_common_ctx *ctx, struct eapol_key_pkt *eapol_key);
